...
private _arr = ["AS_Dim_M73_Krusik_0"];

{
	ADD_ACTION(0,"AS_Dim_M73_Krusik")
	ADD_ACTION(1,"AS_Dim_M73_Krusik")
	ADD_ACTION(2,"AS_Dim_M73_Krusik")
	ADD_ACTION(3,"AS_Dim_M73_Krusik")
	ADD_ACTION(4,"AS_Dim_M73_Krusik")
} forEach _arr;
